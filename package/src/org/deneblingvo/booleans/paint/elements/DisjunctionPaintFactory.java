 ...
 *
 */
public final class DisjunctionPaintFactory extends MixinableFactory {
	...
	public Mixinable newMixin(Cocktailable cocktailable) {
		Disjunction disjunction = (Disjunction)cocktailable;
		return new DisjunctionPaint(disjunction);
	}
